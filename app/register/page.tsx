      ...
      <div className="hero min-h-screen relative z-10">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="text-center lg:text-left">
            ...
            <p className="py-6">
              Ready to test your limits against the best? Forge your legend and compete for glory.
            </p>
          </div>
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? (
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12c1.274 4.057 5.065 7 9.964 7 4.9 0 8.69-2.943 9.964-7-1.274-4.057-5.065-7-9.964-7-4.9 0-8.69 2.943-9.964 7z" />
